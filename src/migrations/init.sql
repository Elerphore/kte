...
insert into customers(name, discount_1, discount_2) values ('Иван', null, null), ('Пётр', 1, null), ('Макс', 2, 3);
...
insert into storeitems(storeitem_name, price) values ('Яблоко', 11), ('Банан', 25), ('Груша', 16), ('Апельсин', 16), ('Шоколадка', 123), ('Кока-Кола', 90);
